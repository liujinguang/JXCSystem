...
public class JXCFrame {
    ...
    private JButton createFrameButton(String fName, String cname) {
        String imgUrl = "ActionIcon" + File.separator + fName + ".png";
        String imgUrl_roll = "ActionIcon" + File.separator + fName
                + "_roll.png";
        String imgUrl_down = "ActionIcon" + File.separator + fName
                + "_down.png";
        Icon icon = new ImageIcon(Utils.getResourceURL(imgUrl));
        Icon icon_roll = null;
        if (imgUrl_roll != null)
            icon_roll = new ImageIcon(Utils.getResourceURL(imgUrl_roll));
        Icon icon_down = null;
        if (imgUrl_down != null)
            icon_down = new ImageIcon(Utils.getResourceURL(imgUrl_down));
    ...
    private void updateBackImage() {
        if (backLabel != null) {
            ...
            backLabel.setText("<html><body><image width='" + backw
                    ...
                    + Utils.getResourceURL("welcome.jpg")
                    + "'></img></body></html>");
        }
    }
